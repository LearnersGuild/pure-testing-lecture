...
(0, _blueTape2.default)('jsonFetch', function (t) {
  ...
  t.test('should fail on error responses', function (tt) {
    ...
    tt.shouldFail((0, _jsonFetch2.default)('https://www.example.com/NotFound'), 'Not Found');
    tt.shouldFail((0, _jsonFetch2.default)('https://www.example.com/ServerError'), 'Internal Server Error');
  });
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 5;
              return (0, _jsonFetch2.default)('https://www.example.com/SomeData');
